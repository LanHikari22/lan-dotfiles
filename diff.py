# pulls all changes in config files from system to repository
import typing
import os
import sys
import argparse
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description=f"compares config files between repository and system \
...
{sys.argv[0]} --all
    ...
    for conf in loc_dic.keys():
        ...
        os.system(f'diff -Naurs --color=always {loc_dic[conf]} {conf}')
